...
export function RentalListPage(props: RentalListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRentals({
        relations: ['tool', 'outlet', 'user_rental_user_idTouser', 'user_user_rental_idTorental.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_rental_user_idTouser',
          header: 'User Rental User Id Touser',
          accessorKey: 'user_rental_user_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_rental_user_idTouser?.id}`}
            >
              {record.user_rental_user_idTouser?.email}
            </Link>
          ),
        }
      : null,
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_user_rental_idTorental',
          header: 'User User Rental Id Torental',
          accessorKey: 'user_user_rental_idTorental',
          cell: ({ row: { original: record } }: any) => record?._count?.user_user_rental_idTorental,
        }
      : null,
