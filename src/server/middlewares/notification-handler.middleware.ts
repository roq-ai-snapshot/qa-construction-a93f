...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'tool.delete': { roles: ['owner', 'admin'], key: 'tool-removed', tenantPath: ['company', 'tool'], userPath: [] },
  'outlet.create': {
    roles: ['owner', 'admin'],
    key: 'new-outlet-created',
    tenantPath: ['company', 'outlet'],
    userPath: [],
  },
  'outlet.delete': { roles: ['owner', 'admin'], key: 'outlet-closed', tenantPath: ['company', 'outlet'], userPath: [] },
  'rental.create': {
    roles: ['owner', 'admin'],
    key: 'new-tool-rental',
    tenantPath: ['company', 'user', 'rental'],
    userPath: [],
  },
  'rental.update': {
    roles: ['owner', 'admin'],
